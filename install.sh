#!/bin/sh
# Install grok-setup-system for the current user on Linux or macOS.
#
...
REPO="NDDev-OpenNetwork/grok-setup-system"
BINARY="grok-setup-system"
VERSION="${1:-0.0.58}"
PREFIX="${GROK_INSTALL_DIR:-$HOME/.local/bin}"
...
echo "  ai-stp provider conformance --harness grok-build \\"
