---
name: nddev-builder
description: Build, review or validate a Grok Build setup for grok-setup-system -- its owned surfaces, the components it carries, the lifecycle it performs, and the gate it must pass. Use when changing grok-setup-system or the native artifacts a setup writes.
---
