...
mod tests {
  ...
  "
    ...
    fn nothing_inside_a_skill_is_stranded() {
        ...
        // grok carries 10 file(s) inside its skill. Stated so that a layout change emptying the skill fails here rather than passing a guard with nothing left to walk.
        assert_eq!(
